      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div>
            ...
            {/* Price */}
            {item.price ? (
              <p className="text-2xl sm:text-3xl text-gold font-bold mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              {whatsappUrl && (
                <a
                  ...
                  className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-[#25D366] hover:bg-[#20BD5A] text-white font-semibold rounded-lg transition-colors"
                >
              ...
              {item.ebay_url && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 flex items-center justify-center gap-2 px-6 py-3 border border-navy text-navy hover:bg-navy hover:text-ivory rounded-lg font-semibold transition-colors"
                >
                  {t("viewOnEbay")}
                </a>
              )}
