  ...
  try {
    ...
    if (
      ...
      return NextResponse.json(
        { error: "eBay is blocking this request. Please try again in a few minutes, or try a different link format (use the full item URL like https://www.ebay.com/itm/123456789)." },
        { status: 503 }
      );
    }
